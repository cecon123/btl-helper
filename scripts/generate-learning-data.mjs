...
const architectureConcepts = [
  ...
  ["Maven multi-module", ["pom.xml", "server/pom.xml", "client/pom.xml", "common/pom.xml"], "Parent pom quan ly version; common/server/client tach dependency dung pham vi.", ["Maven", "Module", "Dependency scope"]],
